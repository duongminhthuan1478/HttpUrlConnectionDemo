...
import static com.example.dell.httpurlconnectiondemo.MainActivity.LOG_TAG;
...
public class QueryUtils {
    ...
    public static ArrayList<UserGitHub> fetchUserGitHub(String requestUrl) {
        ...
        ArrayList<UserGitHub> listUserGitHub = extractFeatureFromJson(jsonResponse);

        return listUserGitHub;
    }

    /**
     * Return a list of {@link UserGitHub} objects that has been built up from
     * parsing a JSON response.
     */
    private static ArrayList<UserGitHub> extractFeatureFromJson(String gitHubJSON) {
